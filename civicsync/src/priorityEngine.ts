// ============================================================
// CivicSync — AI Priority Scoring Engine
// Analyzes title + description to produce a 0–100 priority score
// ============================================================
...
/** Critical/life-threatening — +25 each */
const CRITICAL = [
...
/** Impact scale — multiplier keywords */
const HIGH_IMPACT = [
...
export interface PriorityScore {
  ...
  confidence: number      // 0–100 (how sure we are of the level)
...
export async function fetchGroqPriority(
  ...
  const prompt = `
You are an intelligent Civic Grievance Triage AI. 
...
`
  ...
  try {
    const res = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        model: "llama3-8b-8192", // Fast model for real-time typing
...
export function computePriorityScore(
  ...
  // ── Text length bonus (longer = more detail = likely more serious)
  ...
  // ── Confidence (how far from a boundary)
